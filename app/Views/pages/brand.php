      ...
      <div class="card card-small mb-4">
        <div class="card-header border-bottom d-flex">
          <h6 class="m-0">List <?= $menu ?></h6>
            <div class="ml-auto">
              <button type="button" class="btn btn-primary ml-2" data-toggle="modal" data-target="#modal_brand"> Tambah <?= $menu ?></button>
            </div>
        </div>
...
<div id="modal_brand" class="modal fade" role="dialog">
...
<script type="text/javascript">
  $(function () {
    dt_url = "<?php echo base_url('brand/get_json') ?>";
    dt_columns = [
      {"data" : "id_brand"},
      {"data" : "brand"},
      {"data" : "aksi"}
